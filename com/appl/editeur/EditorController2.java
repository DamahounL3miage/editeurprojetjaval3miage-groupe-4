...
public class EditorController2 {
   ...
   private HTMLEditor htmledit;
    ...
    private boolean choixlang = false;
...
public boolean launch() {
  ...
  langTool = new JLanguageTool(new BritishEnglish()); /* utiliser le dico anglais */
    ...
    if (choixlang) {
        langTool = new JLanguageTool(new French()); /* utiliser le dico anglais */
    }
   else
        langTool = new JLanguageTool(new BritishEnglish()); /* utiliser le dico français */
